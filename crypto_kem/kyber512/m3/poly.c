...
extern void doublebasemul_asm_m3(int16_t *r, const int16_t *a, const int16_t *b, int16_t zeta);
/*************************************************
...
void poly_frombytes_mul(poly *r, const unsigned char *a) {
    ...
    for (i = 0; i < KYBER_N / 4; i++) {
        ...
        doublebasemul_asm_m3(&r->coeffs[4*i], &r->coeffs[4*i], tmp, zetas[i]);
    }
}
...
extern void basemul_asm_m3(int16_t *, const int16_t *, const int16_t *, const int16_t *);
/*************************************************
* Name:        poly_basemul
*
...
void poly_basemul(poly *r, const poly *a, const poly *b) {
    basemul_asm_m3(r->coeffs, a->coeffs, b->coeffs, zetas);
}

extern void basemul_asm_acc_m3(int16_t *, const int16_t *, const int16_t *, const int16_t *);
/*************************************************
...
void poly_reduce(poly *r) {
  asm_barrett_reduce_m3(r->coeffs);
}

extern void pointwise_add_m3(int16_t *, const int16_t *, const int16_t *);
/*************************************************
* Name:        poly_add
*
...
void poly_add(poly *r, const poly *a, const poly *b) {
    pointwise_add_m3(r->coeffs,a->coeffs,b->coeffs);
}


extern void pointwise_sub_m3(int16_t *, const int16_t *, const int16_t *);
/*************************************************
* Name:        poly_sub
*
...
void poly_sub(poly *r, const poly *a, const poly *b) {
    pointwise_sub_m3(r->coeffs,a->coeffs,b->coeffs);
}
