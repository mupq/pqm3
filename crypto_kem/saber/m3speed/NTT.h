...
// https://github.com/multi-moduli-ntt-saber/multi-moduli-ntt-saber/blob/master/gen_table/m3_unmasked/call_gen.c
...
//     for(int i = 0; i < (NTT_N - 1); i++){
//         assert(streamlined_CT_negacyclic_table_Q2[i] == twiddle_int32[i]);
//     }
...
//     for(int i = 0; i < (NTT_N << 1) - 1; i++){
//         assert(streamlined_inv_CT_negacyclic_table_Q2[i] == twiddle_int32[i]);
//     }
...
//     for(int i = 0; i < (NTT_N >> 1); i++){
//         assert(mul_Rmod_table_Q2[i] == twiddle_int32[i]);
//     }
