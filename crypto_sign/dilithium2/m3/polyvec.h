...
#define polyvecl_ntt_leaktime DILITHIUM_NAMESPACE(polyvecl_ntt_leaktime)
void polyvecl_ntt_leaktime(polyvecl *v);
...
void polyvecl_pointwise_acc_montgomery(poly *w,
                                       const polyvecl *u,
                                       const polyvecl *v);
#define polyvecl_pointwise_acc_montgomery_leaktime \
        DILITHIUM_NAMESPACE(polyvecl_pointwise_acc_montgomery_leaktime)
void polyvecl_pointwise_acc_montgomery_leaktime(poly *w,
                                       const polyvecl *u,
                                       const polyvecl *v);
...
#define polyveck_ntt_leaktime DILITHIUM_NAMESPACE(polyveck_ntt_leaktime)
void polyveck_ntt_leaktime(polyveck *v);
#define polyveck_invntt_tomont DILITHIUM_NAMESPACE(polyveck_invntt_tomont)
void polyveck_invntt_tomont(polyveck *v);
#define polyveck_invntt_tomont_leaktime DILITHIUM_NAMESPACE(polyveck_invntt_tomont_leaktime)
void polyveck_invntt_tomont_leaktime(polyveck *v);

#define polyveck_pointwise_poly_montgomery DILITHIUM_NAMESPACE(polyveck_pointwise_poly_montgomery)
void polyveck_pointwise_poly_montgomery(polyveck *r, const poly *a, const polyveck *v);
#define polyveck_pointwise_poly_montgomery_leaktime DILITHIUM_NAMESPACE(polyveck_pointwise_poly_montgomery_leaktime)
void polyveck_pointwise_poly_montgomery_leaktime(polyveck *r, const poly *a, const polyveck *v);
...
#define polyvec_matrix_pointwise_montgomery_leaktime DILITHIUM_NAMESPACE(polyvec_matrix_pointwise_montgomery_leaktime)
void polyvec_matrix_pointwise_montgomery_leaktime(polyveck *t, const polyvecl mat[K], const polyvecl *v);
#endif
