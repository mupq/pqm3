...
#define poly_ntt_leaktime DILITHIUM_NAMESPACE(poly_ntt_leaktime)
void poly_ntt_leaktime(poly *a);

#define poly_invntt_tomont DILITHIUM_NAMESPACE(poly_invntt_tomont)
void poly_invntt_tomont(poly *a);
#define poly_invntt_tomont_leaktime DILITHIUM_NAMESPACE(poly_invntt_tomont_leaktime)
...
#define poly_pointwise_montgomery_leaktime DILITHIUM_NAMESPACE(poly_pointwise_montgomery_leaktime)
...
#define poly_pointwise_acc_montgomery_leaktime DILITHIUM_NAMESPACE(poly_pointwise_acc_montgomery_leaktime)
